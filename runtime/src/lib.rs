// use std::{cell::RefCell, cmp::Ordering, collections::BTreeMap, fmt, iter, rc::Rc};

// use crate::{
//     ast::{Expr, ExprKind, Pattern, PatternKind, Stmt, StmtKind},
//     literal::Literal,
// };
...
//                 }
//             }
//             StmtKind::For { target, iter, body, else_branch } => {
...
//     fn bind_pattern(&mut self, pat: &Pattern, val: &Any) -> Result<(), RuntimeError> {
//         match &pat.kind {
//             PatternKind::Ident(id) => {
//                 self.set_var(id.name.clone(), val.clone());
//                 Ok(())
//             }
//             PatternKind::Atom(a) => match val {
...
//                 }
//             }
//             PatternKind::List(items) => match val {
...
//                 _ => Err(RuntimeError::Other("pattern match failed".into())),
//             },
//             PatternKind::Record(fields) => match val {
//                 Any::Object(o) => match &o.borrow().kind {
//                     ObjectKind::Record(map) => {
//                         for f in fields {
